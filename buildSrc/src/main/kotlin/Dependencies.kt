...
object Dependencies {
    ...
    object AndroidNetwork {
        const val KTOR = "io.ktor:ktor-client-android:2.3.1"
    }
    ...
    object TestRuntime {
        ...
        const val JUNIT_5 = "org.junit.jupiter:junit-jupiter-engine:5.9.3"
    }

    object TestFramework {
        const val JUNIT_4 = "junit:junit:4.13.2"
        const val JUNIT_5 = "org.junit.jupiter:junit-jupiter-api:5.9.3"
        const val ANDROID_JUNIT = "androidx.test.ext:junit:1.1.5"
    }

    object TestUtility {
        const val COROUTINES_TEST = "org.jetbrains.kotlinx:kotlinx-coroutines-test:1.7.1"
    ...
    object TestDouble {
        ...
        const val KTOR_MOCK_ENGINE = "io.ktor:ktor-client-mock:2.3.1"
    }
}
