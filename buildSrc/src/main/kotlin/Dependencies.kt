...
object Dependencies {
    ...
    object AndroidFramework {
        ...
        const val SENTRY = "io.sentry:sentry-android:7.1.0"
    }
    ...
    object AndroidPerformance {
        const val MICROBENCHMARK = "androidx.benchmark:benchmark-junit4:1.2.2"
    }
    ...
    object Commons {
        const val UUID = "com.benasher44:uuid:0.8.4"
