...
internal class GooglePlacesNearbySearchEndpoint(
    ...
    override val path: String = "places:searchNearby"
    ...
    override fun requestBody(pageToken: String, pageSize: Int): String {
        val request = buildJsonObject {
            ...
            put("locationRestriction", GooglePlacesAreaRequest(coordinates, radiusLimitInM).toJsonObject())
        }
