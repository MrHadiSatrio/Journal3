...
class FrontmatterMomentsTest {
    ...
    fun `Writes new moments to the filesystem`() {
        ...
        fileSystem.metadata("content/moments/${moment.id}.md".toPath()).isRegularFile.shouldBeTrue()
    }
    ...
    fun `Deletes forgotten moments from the filesystem`() {
        ...
        fileSystem.exists("content/moments/${moment.id}.md".toPath()).shouldBeFalse()
    }
